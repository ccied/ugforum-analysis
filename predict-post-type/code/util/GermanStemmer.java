...
public class GermanStemmer
{
     ...
     */
    private static void strip( StringBuffer buffer )
    {
      boolean doMore = true;
     ...
     * contextual.
     */
    private static void optimize( StringBuffer buffer )
    {
     ...
     */
    private static void removeParticleDenotion( StringBuffer buffer )
    {
      if ( buffer.length() > 4 ) {
     ...
     */
    private static void substitute( StringBuffer buffer )
    {
      substCount = 0;
     ...
     * as "ÃŸ" remains as "ss".
     */
    private static void resubstitute( StringBuffer buffer )
    {
      for ( int c = 0; c < buffer.length(); c++ ) {
        if ( buffer.charAt( c ) == '*' ) {
